...
const GOOGLE_OAUTH_CLIENT_SECRET = 'GOCSPX-1234567890abcdefghijklmnopqrstuvwxyz';
                   const FACEBOOK_APP_SECRET = process.env.FACEBOOK_APP_SECRET; // SECRET REMOVED — rotate this credential immediately and load from environment variable or secrets manager
